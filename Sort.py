...
pull the hour out from the 'From ' line by finding the time and then splitting
...
for line in handle:
    if line.startswith("From "):
        ...
        time = words[5]
        hour = time[:2]
        hourList[hour] = hourList.get(hour,0) + 1

    else:
        continue

#print(hourList)
sortbyhour = sorted(hourList.items())
for k,v in sortbyhour:
    print (k,v)
